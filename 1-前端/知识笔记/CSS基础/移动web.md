...
从iPhone4开始之后的所有手机都采用了Retina屏幕，所谓 " " 一 一 Retina 一种显示标准，是把更多的像素点压缩至 块屏 幕里从而达到更高的分辨率，俗称视网膜屏幕。这种屏幕有 一个特点，就是它有两种像素，一个是物理像素，一个是逻 辑像素。
...
## 一 圣杯布局（两端固定，中间自适应。这一种效果的名字，非技术的名字）
