...
- 1 <p> 我是一个段落标签 </p>
   ...
   - <p>标签用于定义段落，它可以将整个网页分为若干个段落。其中p为单词 paragraph [ˈpærəgræf] 的缩写，意
...
- 如果希望某段文本强制换行显示，就需要使用换行标签 <br />。其中br为单词 break 的缩写，意为打断、换
...
一 相对路径是从代码所在的这个文件出发，去寻找目标文件的，而我们这里所说的上一级 、下一级和同 级
...
## 注释
   ...
   - 如果需要在 HTML 文档中添加 些便于阅读和理解但又不需要显示在页面中的注释文字，就需要使用注释标 签。
