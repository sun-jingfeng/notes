...
| 目标                   | 建议读法                                                                                                   |
| ---------------------- | ---------------------------------------------------------------------------------------------------------- |
| **临近面试快速过一遍** | 先看每题标题和表格，再只背“定义 + 关键点 + 场景”                                                           |
| **准备深挖追问**       | 结合 `标准化答案` 目录，把对应题目单独展开复习                                                             |
| **按岗位重点复习**     | 前端优先看 JS / React / 工程化 / 浏览器与网络，后端优先看 Java / Spring Boot / MySQL / Redis / 微服务 / MQ |

**推荐答题顺序：** 先一句话定义，再说核心机制或对比，最后补应用场景、注意点和自己的项目经验。
